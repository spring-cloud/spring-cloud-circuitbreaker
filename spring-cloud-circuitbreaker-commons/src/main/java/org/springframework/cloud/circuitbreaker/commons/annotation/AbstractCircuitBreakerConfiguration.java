...
public class AbstractCircuitBreakerConfiguration implements ImportAware {
	...
	public void setImportMetadata(AnnotationMetadata importMetadata) {
		this.enableCircuitBreaker = AnnotationAttributes.fromMap(importMetadata
				.getAnnotationAttributes(EnableCircuitBreaker.class.getName(), false));
		if (this.enableCircuitBreaker == null) {
			throw new IllegalArgumentException(
					"@EnableCircuitBreaker is not present on importing class "
